...
def mock_b2_upload_file(mocker):
    return mocker.patch(
        "storeapi.routers.upload.b2_upload_file", return_value ="https://example.com"
    )
...
async def call_upload_endpoint(async_client=AsyncClient, token: str ="", sample_image: pathlib.Path ="example.png"):
